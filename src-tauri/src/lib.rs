...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::read_camoufox_settings,
            commands::apply_camoufox_settings,
            commands::check_camoufox_capability,
            ...
            commands::start_personal_pilot_core,
            commands::call_personal_pilot_core,
