...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove tauriWailsBridge removal or full settings/core/proxy runtime facade closure; CAPTCHA/SMS/Email credential-backed provider smoke remains separate."
  )
}
