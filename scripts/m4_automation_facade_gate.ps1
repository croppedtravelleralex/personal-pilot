...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove tauriWailsBridge removal, full browser API closure, monitor/app shell runtime closure, or workbench/core facade closure; CAPTCHA/SMS/Email credential-backed provider smoke remains separate."
  )
}
