...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove tauriWailsBridge removal, full monitor/browser/workbench/core facade closure, provider credentials, remote proxy/TLS, cross-machine SessionBundle, AdsPower refresh, or full 450 observed/replay coverage."
  )
}
