...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove tauriWailsBridge removal or full monitor/browser/workbench/core facade closure; CAPTCHA/SMS/Email credential-backed provider smoke remains separate."
  )
}
