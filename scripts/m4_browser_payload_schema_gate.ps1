...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove real headed browser runtime, provider credentials, remote proxy/TLS, cross-machine SessionBundle, AdsPower refresh, or full 450 observed/replay coverage.",
