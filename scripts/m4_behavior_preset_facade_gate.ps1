...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove tauriWailsBridge removal, full browser API closure, or workbench/core facade closure; CAPTCHA/SMS/Email credential-backed provider smoke remains separate."
  )
}
