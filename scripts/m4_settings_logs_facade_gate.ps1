...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It preserves the transitional tauriWailsBridge compatibility proxy and does not prove full bridge removal, profile/workbench/core facade closure, provider credentials, remote proxy/TLS, cross-machine SessionBundle, AdsPower refresh, or full 450 observed/replay coverage."
  )
}
