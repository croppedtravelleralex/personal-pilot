...
$report = [ordered]@{
  ...
  liveTruthBoundary = @(
    ...
    "It does not prove tauriWailsBridge removal or every core/proxy/settings API closure; CAPTCHA/SMS/Email credential-backed provider smoke remains separate."
  )
}
