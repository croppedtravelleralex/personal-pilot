...
const EVIDENCE_KINDS = [
  ...
  { kind: 'm4_monitor_facade', label: 'M4 Monitor' },
  { kind: 'm4_browser_runtime_facade', label: 'M4 Browser Runtime' },
  { kind: 'm4_runtime_facade', label: 'M4 Runtime' },
  { kind: 'm4_browser_settings_core_proxy_facade', label: 'M4 Browser Facade' },
  { kind: 'observed_fingerprint_coverage', label: 'Observed Fingerprint' },
  { kind: 'live_replay_runtime', label: 'Replay Runtime' },
  ...
  { kind: 'm10_headed_stability', label: 'M10 Stability' },
  { kind: 'm15_browser_pool', label: 'M15 Pool' },
  { kind: 'm15_browser_process', label: 'M15 Process' },
