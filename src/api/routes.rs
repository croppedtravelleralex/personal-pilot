...
use super::{auth::auth_middleware, handlers::{
    ...
    check_proxy_trust_cache, explain_proxy_selection, get_proxy, get_task, get_task_logs, get_task_runs, health, list_fingerprint_profiles, repair_proxy_trust_cache,
