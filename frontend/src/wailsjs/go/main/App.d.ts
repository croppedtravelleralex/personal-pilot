...
export function BackupExportPackageToPath(arg1:string):Promise<Record<string, any>>;
...
export function BackupImportPackageFromPath(arg1:string,arg2:boolean):Promise<Record<string, any>>;
...
export function GetAppLogsPage(arg1:number,arg2:number,arg3:string,arg4:string):Promise<logger.MemoryLogPage>;
...
export function WorkbenchFingerprintProfile(arg1:string):Promise<browser.FingerprintSnapshot>;
