...
3. **推进控制面与可见性质量收口主线**，当前已将 Current Stage Snapshot 接入 README 与 AI.md 两个更显眼的项目入口，并补齐双入口维护示例、cheat sheet 与双入口一致性检查；refresh-scope 不再继续扩实现，providerRegion / selection redesign / 广义 trust 语义扩张继续冻结。
