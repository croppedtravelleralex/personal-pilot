...
1. Validation foundation
   ...
   - DNS/transport 首批 observed native collector 与本地 JSON report 已接入。`r`n   - 下一步扩展 WebRTC/canvas/audio/leak collector、report history 和 profile-level evidence export。
