...
5. Runtime adapter and external integration
   ...
   - 2026-06-22 current update：M4 browser window.go fallback shrink 已进入 v28，profile/browser comparison 已 passed；release smoke、external distribution smoke 和第二机/跨机器 portability 已取消为目标，只保留历史 report。
