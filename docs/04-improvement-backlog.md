...
| Session | 完整 `SessionBundle` 和 profile portability | 首个 profile-scoped export contract 已落地；默认脱敏并可显式包含本地敏感 payload；import/restore 未落地 | import/export/restore 与 restart continuity 一起成立 |
